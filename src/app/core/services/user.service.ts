...
export class UserService {
  ...
  createNewPassword(val) {
    return this.http.post(`${this.apiUrl}/user/action/ResetPassword/`, {
  ...
  AcceptEULA(){
    ...
    return this.http.post(`${this.apiUrl}/user/action/AcceptEULA/`, params);  
  }
  ...
  AcceptPHI(){
    ...
    const params = new HttpParams()
    .set('sessionPass', user.SESSION_PASSCODE);
    return this.http.post(`${this.apiUrl}/user/action/AcceptPHI/`, params); 
  }
  ...
  changePassword(UserID, OldPassword, NewPassword){      
    ...
    return this.http.post(`${this.apiUrl}/user/action/ChangePassword/`, params); 
  }
  ...
  Logout(){
    ...
    const params = new FormData()
    .set('sessionPass', user.SESSION_PASSCODE);
    return this.http.post(`${this.apiUrl}/user/action/Logout/`, params); 
  }

  CheckSession(){
    return this.http.get(`${this.apiUrl}/user/action/CheckSession/`,{withCredentials:true});
  }
